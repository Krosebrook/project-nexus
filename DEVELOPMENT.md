...
```bash
git remote add encore encore://project-nexus-database-schema-vpv2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/project-nexus-database-schema-vpv2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/project-nexus-database-schema-vpv2/settings/integrations/github)
