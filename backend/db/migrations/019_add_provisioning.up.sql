...
CREATE INDEX idx_provisioned_databases_project_id ON provisioned_databases(project_id);
CREATE INDEX idx_provisioned_databases_status ON provisioned_databases(status);
CREATE INDEX idx_provisioned_databases_provider ON provisioned_databases(provider);
...
CREATE INDEX idx_database_connection_logs_database_id ON database_connection_logs(database_id);
CREATE INDEX idx_database_connection_logs_created_at ON database_connection_logs(created_at);
